<?php
/*
	This class is my personal rework of FPDF Class, I didn't create it from zero, I copied FPDF Class and modified it
*/
...
*******************************************************************************/
	...
	function __construct($orientation = 'P', $unit = 'mm', $width = 210, $height = 279){
		// Some checks
		$this->_dochecks();
	...
	function OLD__construct($orientation='P', $unit='mm', $size='A4'){
		// Some checks
		$this->_dochecks();
		// Initialization of properties
		$this->state = 0;
